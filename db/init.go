...
CREATE TABLE Note (
    id        INTEGER  PRIMARY KEY
                       UNIQUE
                       NOT NULL,
    notepadid          REFERENCES Notepad (id)
                       NOT NULL,
...
INSERT INTO Note (id, notepadid, title, text, favorite, archived) VALUES (15, 1, 'Destroy all humans', 'Destroy all humans
1. Use virus;
2. wait.', 1, 0);


-- Trigger: UpdateModified
